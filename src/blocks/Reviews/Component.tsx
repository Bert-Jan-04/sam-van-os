...
export const ReviewsBlockComponent: React.FC<ReviewsBlockProps> = ({ heading, items = [] }) => {
  ...
  return (
    <div className="py-14 md:py-[56px]">
      {heading && (
        ...
        <div className="flex w-max gap-5 px-6 md:px-20">
          {items.map((review, index) => (
            ...
            >
              ...
              <p className="mb-6 text-sm leading-relaxed text-ivory-text/70">{review.quote}</p>
